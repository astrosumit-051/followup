...
process.env.DATABASE_URL = 'postgresql://postgres:postgres@localhost:5432/cordiq_dev';
...
console.log(`DATABASE_URL: Using local PostgreSQL (localhost:5432/cordiq_dev)`);
