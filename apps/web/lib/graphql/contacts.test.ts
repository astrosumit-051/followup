...
describe('Contact API Functions', () => {
  ...
  describe('getContact', () => {
    ...
    it('should throw error on request failure', async () => {
      ...
      await expect(getContact('contact-123', mockSupabaseClient)).rejects.toThrow('Network error');
    });
  });
  ...
  describe('createContact', () => {
    ...
    it('should throw error on validation failure', async () => {
      ...
      await expect(createContact(input, mockSupabaseClient)).rejects.toThrow('Validation error');
    });
  });
  ...
  describe('updateContact', () => {
    it('should update existing contact', async () => {
      ...
      const result = await updateContact('contact-123', input, mockSupabaseClient);
    ...
    it('should throw error when contact not found', async () => {
      ...
      await expect(updateContact('non-existent', input, mockSupabaseClient)).rejects.toThrow(
        'Contact not found'
      );
    });
  ...
  describe('deleteContact', () => {
    ...
    it('should throw error when contact not found', async () => {
      ...
      await expect(deleteContact('non-existent', mockSupabaseClient)).rejects.toThrow('Contact not found');
    });
    ...
    it('should throw error on authorization failure', async () => {
      ...
      await expect(deleteContact('contact-123', mockSupabaseClient)).rejects.toThrow('Unauthorized');
    });
  });
});
