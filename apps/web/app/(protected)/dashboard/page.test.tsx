...
describe('DashboardPage', () => {
  describe('Render', () => {
    it('renders dashboard with welcome message', () => {
      ...
      expect(screen.getByText('Welcome to your RelationHub dashboard!')).toBeInTheDocument();
    });
    ...
    it('renders Quick Actions card with shadcn Card components', () => {
      ...
      expect(screen.getByText('Get started by adding contacts or viewing your network.')).toBeInTheDocument();
    });
    ...
    it('renders Getting Started card with shadcn Card components', () => {
      ...
      expect(screen.getByText('RelationHub helps you manage your professional network with AI-powered features.')).toBeInTheDocument();
    });
  ...
  describe('Navigation Links', () => {
    it('renders Quick Add Contact button with correct link', () => {
      ...
      const quickAddButton = screen.getByRole('link', { name: /quick add contact/i });
    ...
    it('renders View All Contacts button with correct link', () => {
      ...
      const viewAllButton = screen.getByRole('link', { name: /view all contacts/i });
  ...
  describe('Card Structure', () => {
    it('uses CardHeader and CardTitle for card structure', () => {
      ...
      const cardTitles = screen.getAllByText(/Quick Actions|Account|Getting Started/);
    ...
    it('uses Separator components between sections', () => {
      ...
      const separators = container.querySelectorAll('hr, [data-orientation="horizontal"]');
    ...
    it('uses CardFooter for additional information', () => {
      ...
      expect(screen.getByText(/More features coming soon including AI email generation and analytics/)).toBeInTheDocument();
    });
  });
  ...
  describe('Accessibility', () => {
    ...
    it('has accessible link text', () => {
      ...
      const quickAddLink = screen.getByRole('link', { name: /quick add contact/i });
      const viewAllLink = screen.getByRole('link', { name: /view all contacts/i });
  ...
  describe('Design Tokens', () => {
    it('uses semantic color tokens for text', () => {
      ...
      const description = screen.getByText('Welcome to your RelationHub dashboard!');
