...
describe('ContactFilters', () => {
  ...
  describe('Filter Interactions', () => {
    ...
    it('calls onFiltersChange when company is selected', async () => {
      ...
      expect(mockOnFiltersChange).toHaveBeenCalledWith({ company: 'Acme Corp' });
    });
    ...
    it('calls onFiltersChange when industry is selected', async () => {
      ...
      expect(mockOnFiltersChange).toHaveBeenCalledWith({ industry: 'Technology' });
    });
  ...
  describe('Dropdown Options', () => {
    it('renders company options from props', async () => {
      ...
      const companySelect = screen.getByLabelText(/Company/);
      expect(companySelect).toContainHTML('<option value="">All companies</option>');
      expect(companySelect).toContainHTML('<option value="Acme Corp">Acme Corp</option>');
      expect(companySelect).toContainHTML('<option value="TechStart">TechStart</option>');
      expect(companySelect).toContainHTML('<option value="InnovateCo">InnovateCo</option>');
    });
    ...
    it('renders industry options from props', async () => {
      ...
      const industrySelect = screen.getByLabelText(/Industry/);
      expect(industrySelect).toContainHTML('<option value="">All industries</option>');
      expect(industrySelect).toContainHTML('<option value="Technology">Technology</option>');
      expect(industrySelect).toContainHTML('<option value="Finance">Finance</option>');
      expect(industrySelect).toContainHTML('<option value="Healthcare">Healthcare</option>');
    });
