...
test.describe('Contact Detail Page', () => {
  ...
  test.describe('Page Load and Navigation', () => {
    test('should load contact detail page with correct URL', async ({ page }) => {
  ...
  test.describe('Contact Information Display', () => {
    ...
    test('should display priority badge with correct styling', async ({ page }) => {
      await page.goto(`/contacts/${mockContact.id}`);
    ...
    test('should display profile picture if available', async ({ page }) => {
      ...
      const profilePicture = page.locator(`img[alt="${mockContact.name}'s profile"]`);
      await expect(profilePicture).toBeVisible();
      await expect(profilePicture).toHaveAttribute('src', mockContact.profilePicture);
  ...
  test.describe('Edit Button', () => {
    ...
    test('should have proper hover styling on Edit button', async ({ page }) => {
      await page.goto(`/contacts/${mockContact.id}`);
  ...
  test.describe('Delete Button and Dialog', () => {
    ...
    test('should remain on detail page after canceling delete', async ({ page }) => {
      await page.goto(`/contacts/${mockContact.id}`);
  ...
  test.describe('Delete Functionality', () => {
    ...
    test('should display success toast after successful deletion', async ({ page }) => {
      await page.goto(`/contacts/${mockContact.id}`);
    ...
    test('should remain on detail page after deletion error', async ({ page }) => {
      await page.goto(`/contacts/${mockContact.id}`);
  ...
  test.describe('Error State', () => {
    test('should display error message when API fails', async ({ page }) => {
      ...
      await page.route('**/graphql', (route) =>
        route.fulfill({
          status: 500,
          body: JSON.stringify({ errors: [{ message: 'Failed to fetch contact' }] }),
        })
      );
    ...
    test('should display Back to Contacts button on error', async ({ page }) => {
      await page.route('**/graphql', (route) =>
        route.fulfill({
          status: 500,
  ...
  test.describe('Not Found State', () => {
    ...
    test('should display helpful message for missing contact', async ({ page }) => {
      await page.route('**/graphql', (route) =>
        route.fulfill({
          status: 200,
          body: JSON.stringify({ data: { contact: null } }),
    ...
    test('should display Back to Contacts button on not found', async ({ page }) => {
      await page.route('**/graphql', (route) =>
        route.fulfill({
          status: 200,
          body: JSON.stringify({ data: { contact: null } }),
  ...
  test.describe('Responsive Design', () => {
    test('should display properly on mobile viewport (375px)', async ({ page }) => {
    ...
    test('should display properly on tablet viewport (768px)', async ({ page }) => {
    ...
    test('should display properly on desktop viewport (1440px)', async ({ page }) => {
    ...
    test('should maintain button layout on smaller screens', async ({ page }) => {
      await page.setViewportSize({ width: 375, height: 667 });
      await page.goto(`/contacts/${mockContact.id}`);
  ...
  test.describe('Accessibility', () => {
    ...
    test('should have accessible labels for definition lists', async ({ page }) => {
      await page.goto(`/contacts/${mockContact.id}`);
    ...
    test('should have proper alt text for profile picture', async ({ page }) => {
      await page.goto(`/contacts/${mockContact.id}`);
