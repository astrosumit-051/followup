...
test.describe('Visual Regression - Contact List Page', () => {
  test('contact-list - light mode - desktop', async ({ page }) => {
    ...
    await page.waitForSelector('[data-testid="contact-card"], [aria-label="No contacts found"]', { timeout: 10000 });
...
test.describe('Visual Regression - Contact Form Page', () => {
  ...
  test('contact-form - validation errors - light mode', async ({ page }) => {
    ...
    await expect(page).toHaveScreenshot('contact-form-errors-light-desktop.png', {
      fullPage: true,
      animations: 'disabled',
    });
  });
...
test.describe('Visual Regression - Signup Page', () => {
  ...
  test('signup - password strength indicator - light mode', async ({ page }) => {
    await page.goto('/signup');
    await setTheme(page, 'light');
    await page.waitForSelector('form');
    ...
    await expect(page).toHaveScreenshot('signup-password-strength-light-desktop.png', {
      fullPage: true,
      animations: 'disabled',
    });
  });
...
test.describe('Visual Regression - shadcn Components', () => {
  test('button-variants - light mode', async ({ page }) => {
    ...
    await expect(quickActionsCard).toHaveScreenshot('button-variants-light.png', {
      animations: 'disabled',
    });
  });
  ...
  test('button-variants - dark mode', async ({ page }) => {
    ...
    const quickActionsCard = page.locator('text=Quick Actions').locator('..');
    await expect(quickActionsCard).toHaveScreenshot('button-variants-dark.png', {
      animations: 'disabled',
    });
  });
  ...
  test('card-component - light mode', async ({ page }) => {
    ...
    const gettingStartedCard = page.locator('text=Getting Started').locator('..');
    await expect(gettingStartedCard).toHaveScreenshot('card-component-light.png', {
      animations: 'disabled',
    });
  });
  ...
  test('card-component - dark mode', async ({ page }) => {
    ...
    const gettingStartedCard = page.locator('text=Getting Started').locator('..');
    await expect(gettingStartedCard).toHaveScreenshot('card-component-dark.png', {
      animations: 'disabled',
    });
  });
});
