...
test.describe("Login Flow", () => {
  ...
  test("should show error for incorrect credentials", async ({ page }) => {
    ...
    await expectErrorMessage(
      page,
      /invalid.*credentials|incorrect.*password|email.*password.*incorrect/i,
    );
  });
  ...
  test("should show error for empty password", async ({ page }) => {
    ...
    const errorMessage = page.locator(
      "text=/password.*required|enter.*password/i",
    );
  ...
  test('should have working "Forgot password?" link', async ({ page }) => {
    ...
    const forgotPasswordLink = page.locator(
      'a:has-text("Forgot"), a:has-text("password")',
    );
  ...
  test("should maintain email value after invalid login attempt", async ({
    page,
  }) => {
