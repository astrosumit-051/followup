...
test.describe("Protected Route Access", () => {
  test.describe("Unauthenticated Access", () => {
    test("should redirect to unauthorized page when accessing /dashboard without authentication", async ({
      page,
    }) => {
    ...
    test("should redirect to unauthorized page when accessing /contacts without authentication", async ({
      page,
    }) => {
    ...
    test("should redirect to unauthorized page when accessing /settings without authentication", async ({
      page,
    }) => {
    ...
    test("should redirect to unauthorized page when accessing /profile without authentication", async ({
      page,
    }) => {
    ...
    test("should preserve intended destination after login redirect", async ({
      ...
      if (!hasRedirectParam) {
        console.log(
          "Note: Login page does not preserve intended destination in URL",
        );
      }
    });
    ...
    test("should handle direct navigation to deeply nested protected routes", async ({
      page,
    }) => {
  ...
  test.describe("Authenticated Access", () => {
    ...
    test("should handle invalid session token gracefully", async ({
      page,
      context,
    }) => {
    ...
    test("should log out and redirect to unauthorized when session is cleared", async ({
      page,
      context,
    }) => {
  ...
  test.describe("Middleware Configuration", () => {
    ...
    test("should apply middleware matcher only to specified routes", async ({
      page,
    }) => {
  ...
  test.describe("Security and Edge Cases", () => {
    ...
    test("should not expose sensitive session information in redirects", async ({
      page,
    }) => {
      // Try accessing protected route
      await page.goto("/dashboard");
    ...
    test("should handle rapid successive requests without race conditions", async ({
      page,
    }) => {
    ...
    test("should handle concurrent requests from different tabs", async ({
      page,
      context,
    }) => {
      // Open multiple tabs
  ...
  test.describe("Performance", () => {
    test("should complete authentication check within reasonable time", async ({
      page,
    }) => {
    ...
    test("should not add significant overhead to public routes", async ({
      page,
    }) => {
      const startTime = Date.now();
